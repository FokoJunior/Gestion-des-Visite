            ...
            <h2>MODIFICATION DE COMPTE</h2>
                <section class="form-section">
                    <form action="../include/modifier.php" method="post">
                        ...
                        <input type="text" name="mot_passe" value="<?php echo $row['nom_utilisateur']; ?>">
                        ...
                        <label for="roles">Rôle:</label>
                            <select name="roles" id="roles">
                                <option value="agent_securite" <?php if ($row['roles'] == 'agent_securite') echo 'selected'; ?>>Agent de sécurité</option>
                                <option value="personne_a_visiter" <?php if ($row['roles'] == 'personne_a_visiter') echo 'selected'; ?>>Cadre</option>

                            </select>

                            <label for="mot_passe">Mot de passe <span class="required">*</span></label>
                        <div class="password-container">
                            <input type="password" id="mot_passe" placeholder="Mot de passe">
