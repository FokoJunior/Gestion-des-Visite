            ...
            <h2>MODIFICATION VISITE</h2>
                <section class="form-section">
                    <form action="../include/modifiervisites.php" method="post">
                        ...
                        <input type="text" name="heure_arrivee" value="<?php echo $row['heure_arrivee']; ?>">

                        <label for="date_jour">Date du jour:</label>
                        <input type="text" name="date_jour" value="<?php echo $row['date_jour']; ?>" >


                        <label for="nom_utilisateur">Nom d'utilisateur:</label>
                        <input type="text" name="nom_utilisateur_affiche" value="<?php echo $row['nom_utilisateur']; ?>" disabled>
                        ...
                        <input type="text" name="heure_sortie" value="<?php echo $row['heure_sortie']; ?>">
